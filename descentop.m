function [xp,yp,hp,cost] = descentop(x,y,h,dhdx,dhdy,xp,yp,g,C,V,cg,cycles,refine,dmax_ini)
%refinementvector should be around 0.991
%change dmax_ini to 0.2
